...
<script src="{{ asset('ui/backend') }}/assets/vendors/chart.js/Chart.min.js"></script>
<script src="{{ asset('ui/backend') }}/assets/vendors/progressbar.js/progressbar.min.js"></script>
<script src="{{ asset('ui/backend') }}/assets/vendors/jvectormap/jquery-jvectormap.min.js"></script>
<script src="{{ asset('ui/backend') }}/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="{{ asset('ui/backend') }}/assets/vendors/owl-carousel-2/owl.carousel.min.js"></script>
...
<script src="{{ asset('ui/backend') }}/assets/js/misc.js"></script>
